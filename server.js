...
function sendSelectedTaxi(req , res , next){
	...
	data = {title : 'Taxi Express' , message : 'SendSelectedTaxi', travelID : req.params.travelID , origin: req.params.origin, req.params.startpoint1: startpoint, valuation : req.params.valuation, phone : req.params.phone, code : 802};
